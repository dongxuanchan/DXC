...
<div id="wrap" class="clr">
    ...
    <div id="main" class="site-main clr">
        ...
        <div class="container">
            ...
            <c:if test="${khachhang[0] == null}" >
                <legend>Tài khoản không tồn tại !</legend>
            </c:if>
            ...
            <div class="form-group">
              ...
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
               <c:if test="${khachhang[0]['tendangnhap'] == null}" >
                    <input  name="username" class="form-control"  type="text">
               </c:if>
               <c:if test="${khachhang[0]['tendangnhap'] != null}" >
                   <input readonly  name="username" value="${khachhang[0]['tendangnhap']}" class="form-control"  type="text">
               </c:if>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" >Họ Tên</label>
                ...
                <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
              <input name="fullname" value="${khachhang[0]['tenkhachhang']}" class="form-control"  type="text">
                </div>
              </div>
            </div>
          ...
          <!-- Text input-->
           ...
           <div class="form-group">
              ...
              <input name="email" value="${khachhang[0]['email']}" class="form-control"  type="text">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input name="phone" value="${khachhang[0]['dienthoai']}" class="form-control" type="text">
                </div>
              </div>
            </div>
            ...
            <!-- Alert messages -->
            <div class="alert alert-success" role="alert" id="success_message">Cập nhật thành công !</div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <span class="btn btn-warning" onClick="capnhatKhachhang()" >Cập nhật  <span class="glyphicon glyphicon-send"></span></span>
              </div>
            </div>
        ...
        <input type="hidden" id="idkhachhang" value="${khachhang[0]['id']}" />
        </form>
        </div>
